 ...
 *
 */
contract CATToken is StandardToken, SafeMath {
    ...
    function CATToken(address multisigInput, uint startBlockInput, uint endBlockInput) {
        owner = msg.sender;
